...
- Native C++ Windows Media Foundation module.
- Windows Media Foundation virtual camera registration through `MFCreateVirtualCamera`.
...
- Zoom may not list the camera unless Media Foundation registration and categories are exactly right.
...
- Native module boundary exists for Media Foundation registration.
...
4. Add C++ Media Foundation native module skeleton with exported registration functions.
...
- Real COM Custom Media Source: `planned`.
